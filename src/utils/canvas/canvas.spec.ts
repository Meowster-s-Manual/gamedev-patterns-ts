import { Vector2D, Canvas, Color } from '@/utils'
...
describe('>>> Canvas', () => {
  ...
  it('should create and attach canvas to the Dom when awakened', () => {
  ...
  describe('>> API', () => {
    ...
    describe('>>> caclulate local point by global', () => {
      beforeEach(() => {
